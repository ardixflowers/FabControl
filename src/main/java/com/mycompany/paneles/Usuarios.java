...
public class Usuarios extends javax.swing.JPanel {
    ...
    private void InitStyles() {
        ...
        buscadorUsuario.putClientProperty("JTextField.placeholderText", "Ingrese el nombre de usuario a buscar.");
    }
    ...
    private void LoadUsers() {
        try {
            ...
            dao.listar("").forEach((u) -> model.addRow(new Object[]{u.getId(), u.getNombre(), u.getApellido_p(), u.getApellido_m(), u.getDomicilio(), u.getTel()}));
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        buscadorUsuario = new javax.swing.JTextField();
        ...
        bgLayout.setVerticalGroup(
            ...
            .addGroup(bgLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(bgLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(buscadorUsuario, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btn_nuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_nuevoActionPerformed
        Vista_Main.ShowJPanel(new UpdateUsuarios());
    ...
    private void btn_editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editarActionPerformed
        if (jTable1.getSelectedRow() > -1) {
            try {
                ...
                DAOUsuarios dao = new DAOUsuariosImpl();
                Vista_Main.ShowJPanel(new UpdateUsuarios(dao.getUsuariosId(userId)));
            } catch (Exception e) {
                System.out.println(e.getMessage());
            }
        } else {
    ...
    private void btn_busquedaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_busquedaActionPerformed
        try {
            ...
            DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
            model.setRowCount(0);
            dao.listar(buscadorUsuario.getText()).forEach((u) -> model.addRow(new Object[]{u.getId(), u.getNombre(), u.getApellido_p(), u.getApellido_m(), u.getDomicilio(), u.getTel()}));
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
    ...
    private javax.swing.JTextField buscadorUsuario;
